...
class LangauageDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('action', function ($row) {
            ...
            if (Auth::guard('admin')->user()->hasPermission('languages-update')){
                ...
                data-target="#modal-edit-language" data-languageid="'.$row->id.'" data-title_ar="'.$row->title_ar.'" data-title_en="'.$row->title_en.'"><i data-feather="edit"></i></button> &nbsp;';
               }else{
            ...
            if (Auth::guard('admin')->user()->hasPermission('languages-delete')){
                $btn = $btn.
                '<form class="delete"  action="' . route("languages.destroy", $row->id) . '"  method="POST" id="delform"
     ...
     *
     * @param \App\Models\Langauage $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Langauage $model)
    {
