...
class NationalDataTable extends DataTable
{
    /**
        ...
        return datatables()
            ...
            ->addColumn('action', function ($row) {
                ...
                if (Auth::guard('admin')->user()->hasPermission('nationals-update')){
                    ...
                    data-target="#modal-edit-national" data-nationalid="'.$row->id.'" data-title_ar="'.$row->title_ar.'" data-title_en="'.$row->title_en.'"><i data-feather="edit"></i></button> &nbsp;';
                   }else{
                ...
                if (Auth::guard('admin')->user()->hasPermission('nationals-delete')){
                    $btn = $btn.
                    '<form class="delete"  action="' . route("nationals.destroy", $row->id) . '"  method="POST" id="delform"
     ...
     *
     * @param \App\Models\National $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(National $model)
    {
