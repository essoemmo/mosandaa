                    ...
                    <form method="POST" id="aboutUs" enctype="multipart/form-data" data-parsley-validate>
                        ...
                        <div class="card-body">
                            <div class="row">
                                @foreach(config('translatable.locales') as $lang)
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="{{$lang}}[title]" value="{{$aboutUs->translate($lang)->title}}" required parsley-trigger="change" placeholder="@lang('admin.title')" />
                                        </div>

                                        <div class="form-group">
                                            <label>@lang('admin.'.$lang.'.description')</label>
                                            <textarea name="{{$lang}}[description]" rows="5" class="form-control" >{{ $aboutUs->translate($lang)->description }}</textarea>
                                        </div>
                                    </div>
                                @endforeach
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group">
                                        @if($aboutUs->websiteImages()->first())
                                            <img src="{{$aboutUs->websiteImages()->first()->image_path}}" width="200" height="100" class="image-show img-thumbnail img-rounded" style="margin-right: 130px;"/>
                                        @else
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="nav-tabs-custom">
                                                ...
                                                <div class="tab-content">
                                                    @forelse($aboutUsItems as  $index => $item)
    ...
    <script>
        $(function () {
            $('body').on('submit','#aboutUs',function (e) {
                ...
                $.ajax({
                    url: '{{ route('about-us.update', $aboutUs->id)}}',
                    method: "post",
