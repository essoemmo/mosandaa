...
<section>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-datatable">
                    {{ $dataTable->table([
                        'class'=> 'datatables-ajax table table-bordered city-table'
                    ],true) }}
    ...
    @if(Auth::guard('admin')->user()->hasPermission('cities-create'))
    <div class="modal modal-slide-in fade" id="modal-add-city">
        <div class="modal-dialog sidebar-sm">
            <form id="addcity" method="POST" class="add-new-record modal-content pt-0" enctype="multipart/form-data" data-parsley-validate>
                @csrf
                @method('post')

                <button type="button" class="close" data-dismiss="modal" aria-label="Close">×</button>
                <div class="modal-header mb-1">
                    <h5 class="modal-title" id="exampleModalLabel">@lang('admin.addcities')</h5>
                </div>
    ...
    <div class="modal modal-slide-in fade" id="modal-edit-city">
        <div class="modal-dialog sidebar-sm">
            <form id="editcity" method="post" class="add-new-record modal-content pt-0" enctype="multipart/form-data" data-parsley-validate>
               @csrf
               @method('put')

               <input type="hidden" name="cityId" id="City_id" class="form-control">

                <button type="button" class="close" data-dismiss="modal" aria-label="Close">×</button>
                <div class="modal-header mb-1">
                    <h5 class="modal-title" id="exampleModalLabel">@lang('admin.editcities')</h5>
                </div>
                <div class="modal-body flex-grow-1">
...
<script>
        ...
        $('body').on('submit','#addcity',function (e) {
            e.preventDefault();
            $.ajax({
