        ...
        <div class="col-12">
            ...
            <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="">@lang('admin.terms')</a>
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">@lang('admin.terms')</h4>
                </div>
                <div class="card-body">
                    <form id="editterm" method="POST" class="add-new-record pt-0" data-parsley-validate>
                        @csrf
                        @method('put')
                    <div class="row">
                    ...
                    <div class="input-group">
                        ...
                        <textarea class="form-control" name="description_ar" cols="10" rows="15" aria-label="With textarea">{!! $term->description_ar !!}</textarea>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        ...
                        <textarea class="form-control" name="description_en" cols="10" rows="15" aria-label="With textarea">{!! $term->description_en !!}</textarea>
                    </div>
                </div>
            </div>
...
<script>
        ...
        $('body').on('submit','#editterm',function (e) {
                e.preventDefault();
                let id = $('#Term_id').val();
